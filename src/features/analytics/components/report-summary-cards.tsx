  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {(Object.entries(summary.counts) as [keyof typeof ANALYTICS_EVENT_TYPE_LABELS, number][]).map(
          ([eventType, count]) => (
            <div key={eventType} className="rounded-lg border border-zinc-200 p-4 dark:border-zinc-800">
      ...
      {summary.mostViewedProperty ? (
        <div className="rounded-lg border border-zinc-200 p-4 dark:border-zinc-800">
          ...
          <p className="font-medium text-zinc-900 dark:text-zinc-50">{summary.mostViewedProperty.title}</p>
